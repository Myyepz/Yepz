# Contact Person:
# [LINE](http://line.me/ti/p/~myyepz)
# [Telegram](https://t.me/myyepz)
# [Instagram](https://www.instagram.com/syarifpy23/) 

# [![Top Langs](https://github-readme-stats.vercel.app/api/top-langs/?username=Myyepz&layout=compact)](https://www.instagram.com/syarifpy23/)
# [![Anurag's github stats](https://github-readme-stats.vercel.app/api?username=Myyepz)](https://www.instagram.com/syarifpy23/)
<html>

  <head>

   <title> .:: Forte Bots ::. </title>
    <meta name='theme-color' content='black'/>
	<meta name="author" content="Yepz"/>
	<meta name="copyright" content="Team ForteBots"/>
	<meta name="description" content="We Are ForteBots Corporation"/>
	<meta name="keywords" content="Team ForteBots"/>
	<meta property="og:title" content="Team ForteBots"/>
	<meta property="og:description" content="We Are ForteBots Corporation"/>	
	<meta property="og:image" content="https://i.ibb.co/QnQkjk2/images-86.jpg"/>
	<link rel="shortcut icon" href="https://i.ibb.co/bPT8yYK/1604594016623.png"/> 
...
;
   ...
   background-image:url(https://i.ibb.co/QnQkjk2/images-86.jpg);background-position:center;background-size:cover;background-attachment:fixed;background-repeat:no-repeat;color:#a2a2a2;min-width:900px;font:12px titillium,arial;font-stretch:condensed;font-size:12px;margin:0;
...
.infoweb {
	...
	border-right: 1px solid #00FFFF;
        ...
        <ext class="flash animated">
         ...
         <center><img src="https://i.ibb.co/bPT8yYK/1604594016623.png" height="400" width="400" /></center>
         
         <body class="fade" style=" overflow: hidden; ">
         <br><br>
                <h1 class="ext_glitch skew">Yepz</h1>
                <h3 class="ext_glitch5">.:: We Are ForteBots Corporation ::.</h2>
                <p class="ext_glitch5">My Team</p>
                <p class="ext_glitch5">.:: Yepz, Inee, Well, Baihaqqi Putra ::.</p>
                <center><h6 class="ext_glitch5">@Copyright Since 2016</h6>
                <iframe width="1" height="0" src="http://www.youtube.com/embed/vd5O33jks6o?rel=0&autoplay=1" frameborder="0" allowfullscreen ></iframe >
